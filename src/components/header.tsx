...
export const Header: React.FC<HeaderProps> = ({ currentView, onMenuClick }) => {
  ...
  return (
    <div className="flex flex-col shrink-0 z-50">
      {/* Top Bar - Dark Slate */}
      <header className="bg-[#2D3E50] text-white h-11 flex items-center justify-between px-4 md:px-6 shrink-0">
        ...
        <div className="flex items-center gap-3 md:gap-8 text-[10px] md:text-[11px] font-bold">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <span className="font-mono tracking-widest text-[10px] md:text-[11px]">{formatTime(currentTime)}</span>
          </div>
        </div>
      </header>
      ...
      <div className="bg-white border-b border-gray-100 h-12 md:h-14 flex items-center justify-between px-4 md:px-8">
        <h1 className="text-[10px] md:text-[12px] font-black text-slate-800 uppercase tracking-widest truncate">
          {getViewTitle()}
        </h1>
        ...
        <div className="flex items-center gap-4 md:gap-10">
          <div className="hidden md:flex items-center gap-3">
            ...
            <span className="text-sm font-black text-[#FF7043]">16:22</span>
          </div>
          <div className="flex items-center gap-3 md:gap-6">
            <p className="hidden sm:block text-[10px] md:text-[12px] font-bold text-slate-700 truncate max-w-[150px] md:max-w-none">
              P Shyam Kumar [ Admin ]
            </p>
            <div className="flex items-center gap-2 md:gap-4">
              <div className="relative cursor-pointer">
                <span className="material-symbols-outlined text-[#FF7043] text-[22px] md:text-[26px]">notifications</span>
              ...
              <button className="material-symbols-outlined text-[#FF7043] transition-colors hover:text-orange-600 text-[22px] md:text-[26px]">
                power_settings_new
              </button>
            </div>
          </div>
